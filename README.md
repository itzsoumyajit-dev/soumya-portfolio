...
│   │
│   ├── 📂 hooks/
│   │   └── 🐙  useGitHub.js          # Unified GitHub API data fetching hook
│   │
│   ├── ⚛️  App.jsx                   # Root application wrapper
│   └── 🎨  index.css                 # Global Cyber-Glass design tokens
│
├── 🔐  .env.example                  # Environment variable template
├── 📦  package.json                  # Dependencies & scripts
├── 🌬️  tailwind.config.js            # Tailwind theme tokens & animations
...
Open `.env` and fill in your values to unlock the GitHub API:
```env
VITE_GITHUB_USERNAME=your_github_username
VITE_GITHUB_TOKEN=your_personal_access_token
```

> 💡 **Required Token Permissions:** `read:user`, `public_repo`
...
**✦ Designed and built with ❤️ by [Soumyajit Saha](https://github.com/itzsoumyajit-dev) ✦**
<br/>
