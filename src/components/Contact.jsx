...
export default function Contact({ profile }) {
  return (
    <section id="contact" className="py-28 md:py-36 relative overflow-hidden bg-gradient-to-b from-transparent to-black/60">
      ...
      {/* Soft Spotlight */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] opacity-20 blur-[150px] pointer-events-none bg-orange-500/20 mix-blend-screen" />
      
      {/* Purple Fog */}
      <div className="absolute bottom-0 left-0 w-full h-[500px] opacity-40 pointer-events-none bg-gradient-to-t from-[#0f0803] to-transparent" />
          ...
          >
            ...
            <div className="space-y-8 mt-auto">
              ...
              <div className="flex items-center gap-5">
                <div className="w-12 h-12 rounded-xl bg-[#29170a] border border-orange-500/20 flex items-center justify-center text-orange-300 shrink-0">
                  <FiMail size={20} />
                </div>
                <div>
                  <h4 className="text-white font-medium text-sm mb-1">Email</h4>
                  <a href={`mailto:${profile?.email || 'soumyajit.dev@gmail.com'}`} className="text-text-tertiary text-sm hover:text-orange-400 transition-colors">
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <a href="https://t.me/itzsoumyajit_dev" target="_blank" rel="noreferrer" className="text-text-tertiary text-sm hover:text-orange-400 transition-colors">
                    @itzsoumyajit_dev
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/itzsoumyajit-dev" target="_blank" rel="noreferrer" className="text-text-tertiary text-sm hover:text-orange-400 transition-colors">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-text-tertiary group-focus-within:text-orange-400 transition-colors">
                      <FiUser size={16} />
                    </div>
                    <input 
                      type="text" 
                      placeholder="Your Name" 
                      className="w-full bg-[#1a0f05]/50 border border-orange-500/20 rounded-xl py-3 pl-11 pr-4 text-sm text-white placeholder-text-tertiary focus:outline-none focus:border-orange-500/50 focus:bg-[#1a0f05]/80 transition-all"
                    />
                  </div>
                  {/* Email Input */}
                  <div className="relative group">
                ...
                {/* Message Input */}
                <div className="relative group">
                  <div className="absolute top-4 left-0 pl-4 flex items-start pointer-events-none text-text-tertiary group-focus-within:text-orange-400 transition-colors">
                    <FiEdit2 size={16} />
                  </div>
                  <textarea 
                    placeholder="Your Message" 
                    rows={4}
                    className="w-full bg-[#1a0f05]/50 border border-orange-500/20 rounded-xl py-3 pl-11 pr-4 text-sm text-white placeholder-text-tertiary focus:outline-none focus:border-orange-500/50 focus:bg-[#1a0f05]/80 transition-all resize-none"
                  />
                </div>
                ...
                <button 
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-orange-600 text-white font-medium text-sm hover:bg-orange-500 transition-colors shadow-[0_0_20px_rgba(234,88,12,0.3)] hover:shadow-[0_0_25px_rgba(234,88,12,0.5)] active:scale-[0.98]"
                >
